                ...
                <div class="w-full lg:w-12/12 px-4">
                    <div class="relative w-full mb-3">
                        ...
                        <textarea name="adress"
                            class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-5 text-gray-600 resize-none"placeholder="Ajoutez votre adresse">{{ old('adress') }}</textarea>
                    </div>
                    @error('adress')
                        <div class="p-4 text-sm text-red-500 rounded-lg  bg-inherit " role="alert">
                            <span class="font-medium">{{ $message }}</span>
